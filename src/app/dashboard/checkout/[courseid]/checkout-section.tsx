...
import CouponeCodeForm from './coupone-code-form';
...
const CheckoutSection = ({
    ...
    }, [setValue, updateTotal, data.price, data.tax, data.offer, data.total]);

    return (
        <CardContent className="px-16 grid grid-cols-3 items-center gap-12">
            <div className="space-y-4 col-span-2">
                <CheckoutForm defaultData={data} />
                <CouponeCodeForm access_token={access_token} course_id={course_id} />
            </div>

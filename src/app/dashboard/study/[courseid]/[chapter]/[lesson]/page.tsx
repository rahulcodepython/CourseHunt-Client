...
const StudyPage = async ({ params }: {
    params: Promise<{ courseid: string | undefined, chapter: string | undefined, lesson: string | undefined }>
}) => {
    const { courseid, chapter, lesson } = await params;
